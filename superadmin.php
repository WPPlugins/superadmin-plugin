<?php
/*
Plugin Name: Superadmin plugin
Author: HiddenKnowledge
Description: This is a plugin that tries to protect the superadmin (userid 1) against attempts to edit or delete this user.
Version: 1.1
*/
...
if(!isset($args[2])||current_user_can("is_super") != true){
return $allcaps;
} else if($args[2] == "1"){
return(false);
}
